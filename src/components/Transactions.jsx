...
import {Container,Grid,Paper,Tabs,Tab,Box,Typography,} from "@material-ui/core";
...
export default function Transactions() {
    ...
    return (
        <Container>
			<Grid container>
				<Grid item xs={12} sm={7} className={classes.papergrid}>
				...
				<Grid item xs={12} sm={5} className={classes.papergrid1}>
					<Paper square={false} className={classes.paper}>
						<Cart
