...
export default function Form(props) {
    ...
    return (
        ...
        <Container component="main" maxWidth="lg">
			<p className="mt-0">&nbsp;</p>
			<p className="headingform mt-3"><ArrowBackIcon onClick={() => props.history.goBack()} className="backbtn"/>
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{method === "POST" ?"Create New User":"Update User"}</p>
...
// const handlesubmit = (e)=>{
    //     e.preventDefault();
    //     async function func(){
    //         let result = await fetch("https://60f2e1206d44f300177887dd.mockapi.io/students",{
    //             method:"POST",
